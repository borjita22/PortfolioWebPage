...
document.querySelectorAll('.nav-item').forEach(item => {
    const formbackground = document.getElementById("contact-form");
    item.addEventListener('mouseover', function() {
        document.body.style.backgroundColor = this.getAttribute('data-bgcolor');
        if(formbackground)
        {
            formbackground.style.backgroundColor = this.getAttribute('data-bgcolor');
        }
    });
    ...
    item.addEventListener('mouseout', function() {
        ...
        if(formbackground)
        {
            formbackground.style.backgroundColor = targetColor;
        }
    });
});
